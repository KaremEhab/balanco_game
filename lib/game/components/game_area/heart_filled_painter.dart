...
class HeartFilledPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint39Fill.color = Color(0xffF22828).withOpacity(1.0);
    ...
    paint40Fill.color = Color(0xffF22828).withOpacity(1.0);
    ...
    paint41Fill.color = Color(0xffF22828).withOpacity(1.0);
