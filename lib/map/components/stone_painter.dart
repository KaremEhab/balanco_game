...
class FirstStonePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint_1_fill.shader = ui.Gradient.linear(
      ...
      [
        Color(0xffB1765E).withOpacity(1),
        Color(0xffC28E72).withOpacity(1),
        Color(0xffE3BB97).withOpacity(1),
        Color(0xffF7D7AD).withOpacity(1),
    ...
    paint_3_fill.shader = ui.Gradient.linear(
      ...
      [
        Color(0xffB8661D).withOpacity(1),
        Color(0xffB55F1E).withOpacity(1),
        Color(0xffA33224).withOpacity(1),
        Color(0xff971628).withOpacity(1),
        Color(0xff930C29).withOpacity(1),
      ],
...
class SecondStonePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint_0_fill.shader = ui.Gradient.linear(
      ...
      [
        Color(0xffC35934).withOpacity(1),
        Color(0xffC5632E).withOpacity(1),
        Color(0xffC97F1F).withOpacity(1),
        Color(0xffCA821D).withOpacity(1),
      ],
      [0, 0.347, 0.945, 1],
    );
    canvas.drawPath(path_0, paint_0_fill);
