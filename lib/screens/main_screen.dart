...
final ValueNotifier<String> playerRoleNotifier = ValueNotifier<String>('BOTH');
...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget _buildTopAppBar(bool isDark) {
    Color textColor = isDark ? const Color(0xFFE0F7FA) : Colors.white;
    Color strokeColor = isDark ? const Color(0xFF01579B) : const Color(0xFF0277BD);

    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10),
      decoration: BoxDecoration(
        color: isDark ? const Color(0xFF0277BD) : const Color(0xFF29B6F6), // Sea Blue
        borderRadius: BorderRadius.circular(30),
        border: Border.all(
          color: isDark ? const Color(0xFF01579B) : const Color(0xFF0288D1),
          width: 3.5,
        ),
        boxShadow: const [
          BoxShadow(
              ...
              children: [
                Text(
                  ...
                  style: GoogleFonts.luckiestGuy(
                    ...
                    height: 1.0,
                    shadows: [
                      Shadow(color: strokeColor, offset: const Offset(0, 2), blurRadius: 0),
                    ],
                  ),
                  maxLines: 1,
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.luckiestGuy(
                      ...
                      height: 1.0,
                      shadows: [
                        Shadow(color: strokeColor, offset: const Offset(0, 1), blurRadius: 0),
                      ],
                    ),
                  ),
                ),
            ...
            builder: (context, mode, _) {
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isDark ? const Color(0xFF455A64) : const Color(0xFF03A9F4),
                    shape: BoxShape.circle,
    ...
    return Row(
      ...
      children: [
        Icon(
          ...
          size: 26,
          shadows: [
            Shadow(color: strokeColor, offset: const Offset(0, 1.5), blurRadius: 0)
          ],
        ),
  ...
  Widget _buildFloatingNavbar(bool isDark) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isDark ? const Color(0xFF01579B) : const Color(0xFF0288D1), // Deep Sea Outline
          width: 3.5,
        ),
        boxShadow: const [
          BoxShadow(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: isSelected
              ? Border.all(color: const Color(0xFF2C3E50), width: 2.5) // Steel Ball Dark Outline
