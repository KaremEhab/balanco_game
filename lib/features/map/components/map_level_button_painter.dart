...
class MapLevelButtonPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    paint0Fill.shader = ui.Gradient.linear(
      ...
      [
        GameColors.mapLevelButtonColor9.withValues(alpha: 1),

        GameColors.mapLevelButtonColor10.withValues(alpha: 1),

        GameColors.mapLevelButtonColor11.withValues(alpha: 1),

        GameColors.mapLevelButtonColor14.withValues(alpha: 1),

        GameColors.mapLevelButtonColor18.withValues(alpha: 1),
      ],
    ...
    paint1Fill.shader = ui.Gradient.linear(
      ...
      [
        GameColors.mapLevelButtonColor15.withValues(alpha: 1),

        GameColors.mapLevelButtonColor16.withValues(alpha: 1),

        GameColors.mapLevelButtonColor21.withValues(alpha: 1),

        GameColors.mapLevelButtonColor27.withValues(alpha: 1),
      ],
    ...
    paint2Fill.shader = ui.Gradient.linear(
      ...
      [
        GameColors.mapLevelButtonColor28.withValues(alpha: 1),

        GameColors.mapLevelButtonColor29.withValues(alpha: 1),

        GameColors.ballHighlight2.withValues(alpha: 1),

        GameColors.mapLevelButtonColor31.withValues(alpha: 1),
      ],
    ...
    paint3Fill.shader = ui.Gradient.linear(
      ...
      [
        GameColors.mapLevelButtonColor12.withValues(alpha: 1),

        GameColors.mapLevelButtonColor13.withValues(alpha: 1),

        GameColors.mapLevelButtonColor19.withValues(alpha: 1),

        GameColors.mapLevelButtonColor23.withValues(alpha: 1),

        GameColors.mapLevelButtonColor25.withValues(alpha: 1),
    ...
    paint4Fill.shader = ui.Gradient.linear(
      ...
      [
        ...
        GameColors.mapLevelButtonColor26.withValues(alpha: 1),

        GameColors.mapLevelButtonColor24.withValues(alpha: 1),

        GameColors.mapLevelButtonColor22.withValues(alpha: 1),

        GameColors.mapLevelButtonColor20.withValues(alpha: 1),

        GameColors.mapLevelButtonColor17.withValues(alpha: 1),
      ],
    ...
    paint5Fill.color = GameColors.mapLevelButtonColor30.withValues(alpha: 1.0);
    ...
    paint6Fill.color = GameColors.yellow.withValues(alpha: 1.0);
    ...
    paint7Fill.color = GameColors.yellow.withValues(alpha: 1.0);
    ...
    paint8Fill.shader = ui.Gradient.linear(
      ...
      [
        GameColors.mapLevelButtonColor1.withValues(alpha: 1),

        GameColors.mapLevelButtonColor2.withValues(alpha: 1),

        GameColors.mapLevelButtonColor3.withValues(alpha: 1),

        GameColors.mapLevelButtonColor4.withValues(alpha: 1),

        GameColors.mapLevelButtonColor5.withValues(alpha: 1),

        GameColors.mapLevelButtonColor6.withValues(alpha: 1),

        GameColors.mapLevelButtonColor7.withValues(alpha: 1),

        GameColors.mapLevelButtonColor8.withValues(alpha: 1),
      ],
    ...
    paint9Fill.color = GameColors.yellow.withValues(alpha: 1.0);
    ...
    paint10Fill.color = GameColors.mapLevelButtonColor32.withValues(alpha: 1.0);
