...
class VictoryCardPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final goldGradient = const LinearGradient(
      ...
      colors: [
        GameColors.victoryPainterColor14,
        GameColors.victoryPainterColor10,
      ],
    ...
    final beigeGradient = const LinearGradient(
      ...
      colors: [
        GameColors.victoryPainterColor16,
        GameColors.victoryPainterColor12,
      ],
...
class VictoryRibbonPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final tailFillPaint = Paint()
      ..color = GameColors
          .victoryGreenDark // Darker green for tails
      ..style = PaintingStyle.fill;

    final frontFillPaint = Paint()
      ..color = GameColors
          .victoryGreenBright // Brighter green for front
      ..style = PaintingStyle.fill;
  ...
  void _drawCurvedText(
    ...
    Offset getPoint(double t) {
      return Offset(
        pow(1 - t, 2).toDouble() * p0.dx +
            2 * (1 - t) * t * p1.dx +
            pow(t, 2).toDouble() * p2.dx,
        pow(1 - t, 2).toDouble() * p0.dy +
            2 * (1 - t) * t * p1.dy +
            pow(t, 2).toDouble() * p2.dy,
      );
    }
    ...
    for (int i = 0; i < text.length; i++) {
      ...
      textPainter.paint(
        canvas,
        Offset(-charW / 2, -textPainter.height / 2 + 3),
      );
...
class GamifiedButtonPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
      ...
      radius,
      Paint()
        ..color = GameColors.victoryPainterColor1
    ...
    canvas.drawCircle(
      center,
      radius,
      Paint()..color = GameColors.victoryPainterColor7,
    );
    ...
    canvas.drawCircle(
      ...
      Paint()
        ..shader = const LinearGradient(
          ...
          colors: [GameColors.victoryPainterColor11, GameColors.headerBrown],
    ...
    canvas.drawCircle(
      center,
      radius - 8,
      Paint()..color = GameColors.victoryPainterColor5,
    );
    ...
    final studPaint = Paint()..color = GameColors.victoryPainterColor15;
    final studShadowPaint = Paint()..color = GameColors.victoryPainterColor5;
