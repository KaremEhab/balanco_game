...
class BombComponent extends PositionComponent
  ...
  BombComponent(this.startPosition, {this.replicaOnly = false})
  ...
  void render(Canvas canvas) {
    ...
    // Spark on fuse
    canvas.drawCircle(
      Offset(5 + 5 * sin(_fuseTimer * 10), -40),
      3 + 2 * sin(_fuseTimer * 30),
      Paint()..color = GameColors.orange,
    );
    ...
    // Cap
    canvas.drawRect(
      Rect.fromCenter(center: const Offset(0, -18), width: 12, height: 6),
      Paint()..color = GameColors.blueGrey.shade900,
    );
