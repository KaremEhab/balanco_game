...
comment on column public.profiles.profile_completed is
  'False until a provider-created player chooses Balanco username, display name, and age.';

-- Accounts previously created without Balanco metadata still need onboarding.
update public.profiles
set profile_completed = false
where username like 'player\_%' escape '\';
